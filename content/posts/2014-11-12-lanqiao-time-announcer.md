...
tags:
  - 蓝桥杯
  - Archived
excerpt: "将时间的小时和分钟转换为英文读法，如 3:00 读作 'three o'clock'，5:30 读作 'five thirty'。"
aiSummary: "本文介绍时间转英文读法的实现思路，核心逻辑是分别处理小时和分钟，当分钟为0时加 'o'clock'，否则直接拼接英文数字。代码使用两个字符串数组分别存储0-20和20、30、40、50的英文表示，通过整除和取模运算组合出最终读法。"
---
