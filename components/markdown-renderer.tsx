...
export function MarkdownRenderer({ content }: MarkdownRendererProps) {
  const components: Components = {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    strong: ({ children }) => (
      <strong className="font-semibold" style={{ color: "var(--prose-bold)" }}>
        {children}
      </strong>
    ),

    em: ({ children }) => (
      <em className="italic" style={{ color: "var(--prose-italic)" }}>
        {children}
      </em>
    ),
    ...
    img: ({ src, alt }) => {
      ...
      return (
        <figure
          style={{ marginTop: SPACING.image, marginBottom: SPACING.image }}
        >
    ...
    code: ({ className, children, ...props }) => {
      ...
      return (
        <CodeBlock code={codeString} language={language} filename={filename} />
      );
    },
